...
class CardAdapter(private val ctx: Context, val listener: CarDItemClickAdapter) :RecyclerView.Adapter<CardAdapter.cardViewHolder>() {
    ...
    class cardViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
        ...
        val cardNumber: TextView = itemView.findViewById(R.id.cardNumber_singleCard)//Item define here
    ...
    override fun onBindViewHolder(holder: cardViewHolder, position: Int) {//Bind the data to the view holder
...
//            editor.commit()
    ...
    override fun getItemCount(): Int {//identify the item list size
